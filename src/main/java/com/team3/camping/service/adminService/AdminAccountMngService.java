...
public interface AdminAccountMngService {
	...
	// 관리자 목록
	public PagingUtil getAdminOrUserList(String strAdminId, String strStartDate, String strEndDate, Integer intStateCode, int intPage
			                            ,int intLimit, String strRole);
	// 관리자 상태 별수
